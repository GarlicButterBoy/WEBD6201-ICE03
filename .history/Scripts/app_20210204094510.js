      ...
      if(localStorage.length > 0)
      {
        ...
        for (let index = 0; index < localStorage.length; index++)
        {
          ...
          data += `<tr>
                  ...
                  <td class="text-center"><button class="btn btn-primary btn-sm" id="editButton-${index + 1}"><i class="fas fa-sm fa-edit"></i> Edit</button></td>
                  <td class="text-center"><button class="btn btn-warning btn-sm" id="deleteButton-${index + 1}"><i class="fas fa-sm fa-trash-alt"></i> Delete</button></td>
                  </tr>`;
        }
