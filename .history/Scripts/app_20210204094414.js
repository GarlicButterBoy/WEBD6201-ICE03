      ...
      if(localStorage.length > 0)
      {
        ...
        for (let index = 0; index < localStorage.length; index++)
        {
          ...
          data += `<tr>
                  ...
                  <tdclass="text-center"><button class="text-center btn btn-primary btn-sm" id="${index + 1}"><i class="fas fa-sm fa-edit"></i> Edit</button></tdclass=>
                  <td class="text-center"><button class=" btn btn-warning btn-sm"><i class="fas fa-sm fa-trash-alt"></i> Delete</button></td>
                  </tr>`;
        }
